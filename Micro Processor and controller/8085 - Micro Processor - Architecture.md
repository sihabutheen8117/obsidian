...
- 8 bit means it bus width , and This means it can perform operations on **8-bit operands** (numbers ranging from 0 to 255 in decimal or 00 to FF in hexadecimal) in a single cycle.
